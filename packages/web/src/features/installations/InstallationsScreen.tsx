...
export function InstallationsScreen(): JSX.Element {
  ...
  return (
    <GlassPanel title="Installations" className="feature-screen installations-screen">
      ...
      <h1>Installations</h1>
      <p>
        An installation is one run of the booth. At most one era is active at a time. Ending one
        leaves the booth between exhibitions until you explicitly start the next: offline is
        expected, new calls are paused, and pending uploads are retained. Ending an era freezes its
