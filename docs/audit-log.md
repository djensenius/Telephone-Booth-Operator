...
| Family        | Actions                                                                                                                                                                                                                                                                       |
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Messages      | `message.create`, `message.complete`, `message.delete`, `message.approve`, `message.reject`, `message.transcription.request`, `message.moderation.request`, `message.translation.submit`, `message.transcription.push`, `message.translation.push`, `message.moderation.push` |
